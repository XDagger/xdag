...
#define CHEATCOIN_VERSION "T13.654-T13.837" /* $DVS:time$ */

/* история

T13.837 добавлена опция -a, позволяющая явно задавать адрес, используемый в майнере;
	изменён способ подсчёта хешрейта
