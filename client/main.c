...
//
//uint64_t unit_test_load_blocks1(xdag_time_t stime, xdag_time_t etime)
//{
...
int xdag_load_case1()
{
    ...
    start = clock();
    uint64_t num = unit_test_load_blocks(stime, etime, &add_block_callback1);
...
int xdag_load_case2()
{
    ...
    start = clock();
    uint64_t num = unit_test_load_blocks(stime, etime, &add_block_callback2);
