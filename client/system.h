...
// By two's complement signed number representation -1 is one's complement of 0 (->thus it's the maximum representable number<-)
...
// shift to the right, pushing zeros
