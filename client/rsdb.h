...
XDAG_RSDB_OP_TYPE xdag_rsdb_get_syncblock(xdag_hashlow_t ref_hash, struct sync_block*);
...
XDAG_RSDB_OP_TYPE xdag_rsdb_seek_syncblock(xdag_hashlow_t, struct sync_block*);
