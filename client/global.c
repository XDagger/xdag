...
int g_pub_key_compress = 0; // switch of pub key and signature compression
int g_snapshot_integer = 1; //switch of using integer OR hash as key, using integer will do balance compression
int g_snapshot_pub_key = 1; // switch of snapshot pub key
